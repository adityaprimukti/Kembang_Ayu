        ...
        <div className="navbar">
          <div className="frame-parent">
            ...
            <div className={`frame-group ${isMobileMenuOpen ? "open" : ""}`}>
              ...
              <div className="kembang-ayu-wrapper">
              <Link to="/loginadmin" className="no-underline">            
                <div className="ContactUs">Admin</div>
                </Link>
              </div>
            </div>
            <div
      ...
      <div className="customer-say">
        ...
        <div className="what-our-customer-say-parent">
          ...
          <div className="vector-container">
            <img className="instance-child-assesment" alt="" src="/rectangle-141.svg" />
            <Link to="/testimoni">
